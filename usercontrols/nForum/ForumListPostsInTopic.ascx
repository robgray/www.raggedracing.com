...
<div id="topicpostlist" class="topicpostlist" runat="server">
    <asp:Repeater ID="rptTopicPostList" runat="server" onitemdatabound="SortIndividualPostActions">       
        <ItemTemplate>
            <div class="forumpost<%#IsSolution(((ForumPost)Container.DataItem).ForumPostIsSolution)%> forumpost<%#((ForumPost)Container.DataItem).Id%>">
                ...
                <div class="wmd-output forumpostbody">
                    ...
                    <div class="forumpostbodytop">
                        <asp:Literal ID="litMemberName" runat="server" /> posted this <%# Helpers.GetPrettyDate(((ForumPost)Container.DataItem).CreateDate.ToString())%> 
                    ...
                    <%# ((ForumPost)Container.DataItem).ForumPostContent.ConvertBbCode() %>
                    </div>
                ...
                <div class="forumpostkarmaouter">
                    ...
                    <asp:Panel CssClass="forumpostkarma" runat="server" ID="forumpostkarma">
                        <span class="karmascore karma<%#((ForumPost)Container.DataItem).Id%>"><%# GetPostKarma(((ForumPost)Container.DataItem).ForumPostKarma)%></span>
