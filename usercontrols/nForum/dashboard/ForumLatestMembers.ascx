...
<umbraco:Pane ID="FilterPane" runat="server">        
        ...
        <p>This dashboard shows the latest members to sign up to your forum, if you are pre-authorising members then you can use this to quickly 
        authorise new members.</p>
