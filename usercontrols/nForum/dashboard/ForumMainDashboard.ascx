...
<umbraco:Pane ID="FilterPane" runat="server">        
        ...
        <p>This dashboard flags up posts which have been voted as negative, this can 
        either be because they are spam or because they are inappropriate</p>
                ...
                <asp:TemplateField HeaderText="Name">
                    <ItemTemplate>                    
                        <h3 style="padding:6px;"><a href='<%#String.Format("/umbraco/editContent.aspx?id={0}", ((ForumPost)Container.DataItem).Id)%>'>
                            <%# ((ForumPost)Container.DataItem).NodeName%></a></h3>
                    </ItemTemplate>
                </asp:TemplateField>

                 <asp:TemplateField HeaderText="Karma">
                    <ItemTemplate>
                        <h3 style="padding:6px;"><%# ((ForumPost)Container.DataItem).ForumPostKarma%></h3>
                   </ItemTemplate>
                </asp:TemplateField>
